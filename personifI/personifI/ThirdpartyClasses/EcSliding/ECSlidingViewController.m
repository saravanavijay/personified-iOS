...
//#import "IATNiPhoneMenuViewController.h"
...
//    return ((toInterfaceOrientation == UIInterfaceOrientationPortrait) | UIInterfaceOrientationMaskLandscape);
//}
...
- (void)setUnderLeftViewController:(UIViewController *)theUnderLeftViewController
{
    ...
    //    IATNiPhoneMenuViewController *menuVC =(IATNiPhoneMenuViewController *) _underLeftViewController;
     //   menuVC.isfromslidingVC  = YES;
        //_underLeftViewController.isfromslidingVC
...
- (void)updateUnderLeftLayout
{
    if (self.underLeftWidthLayout == ECFullWidth) {
        ...
        //nishit
        //      CGRect inRect = CGRectMake(self.view.bounds.origin.x, self.view.bounds.origin.y, self.view.bounds.size.width - 500, self.view.bounds.size.height);
